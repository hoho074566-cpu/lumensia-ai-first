...
const STATE_SCHEMA = {
  ...
  required: ['observations', 'promotions', 'relationship_observations', 'relationship_changes', 'scene_state', 'continuity_memory'],
};
