...
assert.match(api, /physical detail carries character or consequence/, 'details should carry scene meaning instead of decorating prose');
...
assert.match(api, /모임 전체를 끝내지 않은 채/, 'scene grammar must demonstrate depth before event completion');
assert.match(api, /정보 전달 사이에도 사람들의 행동이 계속된다/, 'scene grammar must demonstrate people moving through information delivery');
